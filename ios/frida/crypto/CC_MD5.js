...

{
    ...
    onEnter: function (log, args, state) {
      log('CC_MD5()');
      this.source   = args[0]
      this.sourceLength = args[1]
      this.out = args[2];
      console.log('IN: ' + hexdump(ptr(this.source), {
              length: this.sourceLength.toInt32(),
              header: true,
              ansi: true
      }))
  
    },
  // 5cd4e1d7c54ae62792b80b2fcd5fe866
    /**
    ...
    onLeave: function (log, retval, state) {
        console.log('OUT:' + hexdump(ptr(this.out), {
              length: 16,
              header: true,
              ansi: true
      }))
