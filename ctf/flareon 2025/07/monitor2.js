...
const jsonx = base.add(0x066A60 )


const key_expansion = base.add(0x0A54B8)

Interceptor.attach(key_expansion, {
    onEnter(args) {
      this.arg0 = args[0]
      this.arg1 = args[1]
      console.log("RCX",hexdump(this.context.rcx))
      console.log("RDX",hexdump(this.context.rdx))
...
Interceptor.attach(target2, {
  onEnter(args) {
    ...
    //  console.log('    src = ', this.srcPtr.readCString());
        ...
        console.log(hexdump(this.srcPtr,
   { offset: 0,
    length: 512,
}))


        console.log(hexdump(this.dstObj,
   { offset: 0,
    length: 512,
}))
  ...
  onLeave(retval) {
   ...
   { offset: 0,
    length: 512,
      ...
      //  console.log('    src = ', this.dstObj.readCString());
